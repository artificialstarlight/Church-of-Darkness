...
/* The "module___internal__" is a Python object pointer of module type.
 *
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_5_complex_call_helper_star_list_star_dict(PyObject **python_pars) {
    ...
    }
    {
        ...
        tmp_key_name_1 = tmp_mapping_1__key;
        CHECK_OBJECT(tmp_mapping_1__dict);
        tmp_dict_name_1 = tmp_mapping_1__dict;
    ...
    branch_yes_4:;
    {
        ...
        tmp_res = PyObject_HasAttr(tmp_expression_name_3, const_str_plain___iter__);
        tmp_or_left_value_1 = (tmp_res != 0) ? NUITKA_BOOL_TRUE : NUITKA_BOOL_FALSE;
        tmp_or_left_truth_1 = tmp_or_left_value_1 == NUITKA_BOOL_TRUE ? 1 : 0;
        if (tmp_or_left_truth_1 == 1) {
            goto or_left_1;
    ...
    branch_no_5:;
    {
        ...
        tmp_left_name_3 = const_str_digest_adc474dd61fbd736d69c1bac5d9712e0;
        CHECK_OBJECT(par_called);
...

        {
            ...
            tmp_tuple_element_3 = impl___internal__$$$function_3_get_callable_name_desc(dir_call_args);
        }
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_7_complex_call_helper_pos_star_list_star_dict(PyObject **python_pars) {
    ...
    branch_yes_4:;
    {
        ...
        tmp_tuple_element_2 = LOOKUP_ATTRIBUTE(tmp_expression_name_4, const_str_plain___name__);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_4_complex_call_helper_pos_keywords_star_dict(PyObject **python_pars) {
    ...
    branch_no_5:;
    {
        ...
        tmp_dictset_value = LOOKUP_SUBSCRIPT_CONST(tmp_expression_name_4, tmp_subscript_name_3, 1);
        if (tmp_dictset_value == NULL) {
            assert(ERROR_OCCURRED());
...
PyObject *modulecode___internal__(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module___internal__);
