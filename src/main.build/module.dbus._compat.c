...
/* The "module_dbus$_compat" is a Python object pointer of module type.
 *
...
static PyObject *const_str_digest_7821f957cdb6b4e4f75d8870366ca8f7;
...
static void createModuleConstants(void) {
    const_str_plain_major = UNSTREAM_STRING_ASCII(&constant_bin[ 27391 ], 5, 1);
    const_str_digest_7821f957cdb6b4e4f75d8870366ca8f7 = UNSTREAM_STRING_ASCII(&constant_bin[ 27396 ], 50, 0);
    const_str_digest_8ef93c92c5f75aac441373814f070057 = UNSTREAM_STRING_ASCII(&constant_bin[ 27446 ], 21, 0);
...
static PyCodeObject *codeobj_a4020f94af373974817dc8406997bdf7;

static void createModuleCodeObjects(void) {
    module_filename_obj = const_str_digest_7821f957cdb6b4e4f75d8870366ca8f7;
    codeobj_a4020f94af373974817dc8406997bdf7 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_8ef93c92c5f75aac441373814f070057, const_tuple_empty, 0, 0, 0);
}
...
function_impl_code functable_dbus$_compat[] = {
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    function_impl_code *current = functable_dbus$_compat;
    int offset = 0;
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (offset > sizeof(functable_dbus$_compat) || offset < 0) {
...
PyObject *modulecode_dbus$_compat(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    module_dbus$_compat = module;
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("dbus._compat: Calling setupMetaPathBasedLoader().\n");
#endif
...
#ifdef _NUITKA_TRACE
    PRINT_STRING("dbus._compat: Calling createModuleConstants().\n");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    PRINT_STRING("dbus._compat: Calling createModuleCodeObjects().\n");
#endif
    createModuleCodeObjects();

    // PRINT_STRING("in initdbus$_compat\n");
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_dbus$_compat);
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_a4020f94af373974817dc8406997bdf7;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_7821f957cdb6b4e4f75d8870366ca8f7;
        UPDATE_STRING_DICT0(moduledict_dbus$_compat, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2);
    }
    // Frame without reuse.
    frame_a4020f94af373974817dc8406997bdf7 = MAKE_MODULE_FRAME(codeobj_a4020f94af373974817dc8406997bdf7, module_dbus$_compat);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_a4020f94af373974817dc8406997bdf7);
    assert(Py_REFCNT(frame_a4020f94af373974817dc8406997bdf7) == 2);
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_7821f957cdb6b4e4f75d8870366ca8f7;
    ...
    }
    {
        ...
        frame_a4020f94af373974817dc8406997bdf7->m_frame.f_lineno = 4;
    ...
    }
    {
        ...
        tmp_compexpr_left_1 = LOOKUP_ATTRIBUTE(tmp_expression_name_1, const_str_plain_major);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_a4020f94af373974817dc8406997bdf7);
#endif
    popFrameStack();

    assertFrameObject(frame_a4020f94af373974817dc8406997bdf7);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_a4020f94af373974817dc8406997bdf7, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_a4020f94af373974817dc8406997bdf7->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_a4020f94af373974817dc8406997bdf7, exception_lineno);
    }
